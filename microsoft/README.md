> NOTE: Microsoft team created their [`@azure/msal-react`](https://www.npmjs.com/package/@azure/msal-react) and it can be used as a good official alternative to `@sse-auth/microsoft`
