[![NPM Downloads](https://img.shields.io/npm/dm/%40sse-auth%2Fgoogle?style=flat)](https://www.npmjs.com/package/@sse-auth/google)
[![NPM Downloads](https://img.shields.io/npm/dt/%40sse-auth%2Fgoogle?style=flat)](https://www.npmjs.com/package/@sse-auth/google)
...
# SSE React Google Login

> A Google oAUth Sign-in / Log-in Component for React

<!-- ## Storybook -->

<!-- [Demo Link](https://anthonyjgrove.github.io/@sse-auth/google/) -->

## Install
```
npm install @sse-auth/google
```
...
import GoogleLogin from '@sse-auth/google';
// or
import { GoogleLogin } from '@sse-auth/google';
...
## Login Hook
```js
import { useGoogleLogin } from '@sse-auth/google'
...
## Logout Hook
```js
import { useGoogleLogout } from '@sse-auth/google'
...
```js
    import { GoogleLogout } from '@sse-auth/google';
    <GoogleLogout
      clientId="658977310896-knrl3gka66fldh83dao2rhgbblmd4un9.apps.googleusercontent.com"
      buttonText="Logout"
